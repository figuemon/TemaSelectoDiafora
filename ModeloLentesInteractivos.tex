...
los árboles de manera automática entre estas se destacan la diferencia mínima de tripletas (MDT), y la
 ...
 la visualización vuelve a su estado original.
 \item  \emph{La selección:} La selección captura lo que debe ser resaltado por una lente. Normalmente, el usuario controla la selección 
 a través de movimientos sobre la representación visual de los datos.

 \subsection{Técnicas para destacar las diferencias taxónomicas:}

 \subsection{Visualización de Lentes Interactivos configurable para las taxonomías:}

 \subsection{Nuevo mecanismo de configuración para la visualización:}

 \subsection{Capas de filtrado para la visualización:}

 \subsection{Fórmulas de transformación:}
